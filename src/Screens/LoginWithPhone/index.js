...
class App extends Component {
  ...
  render() {
    const {countryCode, phone, showPicker, calling} = this.state;
    ...
    return (
      <ImageBackground
        ...
        <View
          ...
          <View
            ...
            <View style={{marginLeft: 15, flex: 1}}>
              ...
              <TextInput
                ...
                value={phone}
                onChangeText={phone => this.setState({phone, error: false})}
          ...
          <TouchableOpacity
            onPress={() => {
              this.props.navigation.navigate('Verification', {next: 'Home'});
            }}
            style={{
              width: '80%',
              height: 50,
