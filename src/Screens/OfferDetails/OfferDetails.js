...
const OfferDetails = ({ navigation }) => {
  return (
    <View
      ...
      <HeaderComponent hdrText={'OFFER DETAILS'} img={imagePath.icBack}
      ...
      <ScrollView
        ...
        <View style={{ padding: 20 }}>
          ...
          <Text style={{ fontSize: 14, marginTop: 15, color: Colors.text }}>Lorem ipsum  feugiat nisi ut, suscipit dolor. Quisque venenatis odio et dui volutpat, ut pharetra risus dictum. Vestibulum et velit libero. Fusce vel nisi sapien. Curabitur sed es consectetur adipiscing elit. Proin commodo dolor leo, id tincidunt nisl ultricies vel. Sed at ligula consectetur, iaculis sapien vel, pellentesque erat. Mauris vel lacus facilisis, feugiat nisi ut, suscipit dolor. Quisque venenatis odio et dui volutpat, ut pharetra risus dictum. Vestibulum et velit libero. Fusce vel nisi sapien. Curabitur sed es</Text>
